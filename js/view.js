...
var View = {
    ...
    setAttributeAt: function(gridX, gridY, attr, value) {
        ...
        var pageX = Math.floor((Math.random() * 100) + 1);
        var pageY = Math.floor((Math.random() * 100) + 1);
        switch (attr) {
        case 'walkable':
        ...
        case 'opened':
            ...
            var not_walkable = 100; // lets make 3 fields not walkable, do not make it bigger then width*height or you will run in an endless loop.
            var i = 0;
            for (i = 0; i < 2; i++) {
